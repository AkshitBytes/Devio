...
import { getLeaderboard, studentDashboard, teacherDashboard } from "../controllers/dashboard.controller.js"

const router = express.Router();
router.get("/student",protect,studentsonly,studentDashboard)
router.get("/leaderboard", protect, studentsonly, getLeaderboard)
